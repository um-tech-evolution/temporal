...
function ev_init()
  ...
  global burn_in = 0.0
  global tr = TemporalEvolution.temporal_result(simtype, num_trials, N, num_attributes, num_subpops, ngens, mutation_stddev, num_emmigrants, 
